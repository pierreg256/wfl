...
(function() {
  var AWS, Activity, ActivityResponse, Application, Decider, DecisionResponse, checkUtils, createApplication, inspect, path, spawn;
  ...
  Application = (function() {
    ...
    Application.prototype.start = function(inputValue) {
      ...
      return this._checkConfig(function() {
        ...
        return _this.swf.client.startWorkflowExecution(swfCfg).always(function(response) {
          if (response.error != null) {
            _this.logger.error("Unexpected error starting workflow", response.error);
          }
    ...
    Application.prototype._checkConfig = function(callBack) {
      ...
      if (this.configStatus === 0) {
        ...
        return checkUtils.checkDomain(this.swf.client, this.options.domain, this.options.force, function(err, data) {
          if (err != null) {
            ...
            return checkUtils.checkWorkflow(_this.swf.client, _this.options.domain, _this.options.name, _this.options.decider.taskList(), _this.options.force, function(errD, dataD) {
              var func, i;
              if (errD != null) {
                _this.configStatus = 0;
                ...
                func = function(e, d) {
                  if (e != null) {
                    ...
                    if (_this.options.activities[i] != null) {
                      return checkUtils.checkActivity(_this.swf.client, _this.options.domain, _this.options.activities[i].name, _this.options.activities[i].taskList, _this.options.force, func);
                    } else {
