...
(function() {
  var Activity, ActivityResponse, Application, Decider, DecisionResponse, Swf, amazon, awssum, checkUtils, createApplication, inspect, path;
  ...
  Application = (function() {
    ...
    function Application(options) {
      var swfCfg, winston, _base, _base1, _base2, _base3, _base4, _base5, _base6, _ref, _ref1, _ref10, _ref11, _ref12, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    ...
    Application.prototype._startListeners = function() {
      var activ, i, startActivities, startDecider, _i, _len, _ref, _results;
      startActivities = "YES";
      startDecider = "YES";
      if (this.config.get('activitiesOnly')) {
        startDecider = "NO";
      }
      if (this.config.get('deciderOnly')) {
        startActivities = "NO";
      }
      this.logger.info("Workflow application " + this.options.domain + "/" + this.options.name + " listening with the following options:");
      this.logger.info("   listen for decision tasks: " + startDecider);
      this.logger.info("   listen for activity tasks: " + startActivities);
      if (startDecider === "YES") {
        this.options.decider.listen();
      }
      _ref = this.options.activities;
      _results = [];
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        activ = _ref[i];
        _results.push(startActivities === "YES" ? activ.poll() : void 0);
      }
      return _results;
    };
